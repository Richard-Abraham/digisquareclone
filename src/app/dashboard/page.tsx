...
import { Plus, Search, UserCircle, X, Clock } from "lucide-react";
        ...
        <div className="flex-shrink-0 px-4 sm:px-6 py-4 border-b border-border-subtle bg-surface animate-fade-in space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
              ...
              <StatCard label="Overdue" value={overdueCount} sub={overdueCount > 0 ? "Needs attention" : "On track"} icon={<Clock size={18} />} color={overdueCount > 0 ? chartColors.red : chartColors.emerald} />
            </div>
          </div>
